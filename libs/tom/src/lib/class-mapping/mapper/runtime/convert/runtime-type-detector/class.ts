import { getSchema, TomPropertySchema, TypeSystem } from '../../../../../schema';
import { ClassMappingContext } from '../../../class-mapping-schema-context';
import { mapperRuntimeTypeDetectorRegistry } from '../../mapping';

export function classRuntimeTypeDetector(v: any, context: ClassMappingContext<any, any>, tProp: TomPropertySchema, sProp: TomPropertySchema) {
