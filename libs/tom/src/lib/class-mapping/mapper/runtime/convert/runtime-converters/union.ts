import { TypeSystem, TomPropertySchema, determineUnionListResolveOrder } from '../../../../../schema';
...
function *traverseUnion<S, T>(tProp: TomPropertySchema<T>, sProp: TomPropertySchema<S>) {
