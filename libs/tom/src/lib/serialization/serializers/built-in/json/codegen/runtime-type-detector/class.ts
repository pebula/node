import { TomPropertySchema, getSchema } from '../../../../../../schema';
...
export function classIdentifierTypeDetectorSerializer(v: any, context: ClassSerializerContext<any>, prop: TomPropertySchema) {
...
export function classIdentifierTypeDetectorDeserializer(v: any, context: ClassSerializerContext<any>, prop: TomPropertySchema) {
  const classSchema = getSchema(prop.type);
  const { discriminator } = classSchema;
