import { mapTypes, defineClassMapping, P, C } from '@pebula/tom/mapping';
import { jitCompilerStrict } from '../../../mapping/mapper/compiler/errors';
import { invalidPropertyMapDefinitions } from '../../../mapping/mapping-schema/class-mapping-schema/errors';
