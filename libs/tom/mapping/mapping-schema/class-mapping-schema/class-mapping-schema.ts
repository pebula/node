...
export class ClassMappingSchema<S, T, TData = any> {
  ...
  readonly targetClassSchema: Schema.TomClassSchema<T>;
  readonly sourceClassSchema: Schema.TomClassSchema<S>;
  ...
  constructor(public readonly source: Type<S>,
    ...
    this.sourceClassSchema = Schema.getSchema(source);
    this.targetClassSchema = Schema.getSchema(target);
  }
