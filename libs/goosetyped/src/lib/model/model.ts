...
export type MongooseModelModified<T extends Document, H = {}> = {
  [P in keyof MongooseModel<T, H>]: MongooseModel<T, H>[P] extends (...args: infer Params) => Query<infer R, T, H>
    ? (...args: Params) => DocumentQuery<R, T, H>
    : MongooseModel<T, H>[P]
  ;
}
